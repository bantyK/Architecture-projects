 ...
 */
class FullBannerAdapter(private val mSubjectList: List<String>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(context).inflate(R.layout.horizontal_list_item_layout_2, parent, false)
